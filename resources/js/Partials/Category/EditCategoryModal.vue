        ...
        <div
              ...
              <form @submit.prevent="submitForm" class="mt-4">
                <div class="sm:flex sm:items-center justify-between">
                  ...
                  <input type="text" id="categoryName" name="categoryName"
                    class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block sm:w-4/6 sm:text-sm border-gray-300 rounded-md"
          ...
          <div class="bg-indigo-200 px-4 py-3 sm:px-6 sm:flex sm:flex-row justify-end">
            <button @click="submitForm" type="submit"
              class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-emerald-500 text-base font-medium text-white hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:w-auto sm:text-sm mr-2 min-w-20 mt-2">
              Save
            </button>

            <button @click="closeModal" type="button"
              class="min-w-20 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:w-auto sm:text-sm mt-2">
              Cancel
            </button>
          </div>
        </div>
